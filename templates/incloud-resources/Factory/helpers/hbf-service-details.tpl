{{- define "netguard.web-resources.factory.manifets.hbf-service-details" -}}
{{- $key          := (default "hbf-service-details" .key) -}}
    ...
    - type: antdTabs
      data:
        ...
        items:
                                  ...
                                  - type: Labels
                                    data:
                                      containerStyle:
                                        marginTop: -30px
                                      editModalWidth: 650
                                      endpoint: "/api/clusters/{{ $pathIndexCluster }}/k8s/apis/netguard.sgroups.io/v1beta1/namespaces/{{ $pathIndexNamespace }}/services/{{ $pathIndexResName }}"
                                      id: labels-editor
                                      inputLabel: ""
                                  ...
                                  - type: VisibilityContainer
                                    data:
                                      ...
                                      style:
                                        margin: 0
                                        padding: 0
                                      value: "{reqsJsonPath[0]['.items.0.spec.ingressPorts']['-']}"
                                    children:
                                    - type: EnrichedTable
                                      data:
                                        id: service-port-mapping-tableservice-port-mapping-table
                                        cluster: "{{ $pathIndexCluster }}"
                                        customizationId: factory-hbf-service-details-port-mapping
                                        baseprefix: "/{{ $pathIndexBasePrefix }}"
                                        pathToItems: ".items.0.spec.ingressPorts"
                                        k8sResourceToFetch: 
          ...
          - key: address-group-binding
            label: Address Group Binding
            children:
              - data:
                  baseprefix: /{{ $pathIndexBasePrefix }}
                  cluster: '{{ $pathIndexCluster }}'
                  customizationId: stock-namespace-/netguard.sgroups.io/v1beta1/addressgroupbindings
                  id: conditions-table
                  pathToItems: .items
                  ...
                  k8sResourceToFetch: 
                    ...
                    namespace: "{{ $pathIndexNamespace }}"
                  fieldSelector:
                    spec.serviceRef.name: "{{ $pathIndexResName }}"
                    spec.serviceRef.namespace: "{{ $pathIndexNamespace }}"
                type: EnrichedTable
          ...
          - key: rules-from
            ...
            children:
              - data:
                  baseprefix: /{{ $pathIndexBasePrefix }}
                  cluster: '{{ $pathIndexCluster }}'
                  customizationId: stock-namespace-/netguard.sgroups.io/v1beta1/services-as-service
                  id: conditions-table
                  pathToItems: .items.0.xSvcSvcRules.asServiceFrom
                  withoutControls: false
                  namespace: "{{ $pathIndexNamespace }}"
                  isNamespaced: true
                  dataForControls:
          ...
          - key: rules-to
            ...
            children:
              - data:
                  ...
                  customizationId: stock-namespace-/netguard.sgroups.io/v1beta1/services-as-service
                  id: conditions-table
                  pathToItems: .items.0.xSvcSvcRules.asServiceTo
                  withoutControls: false
                  namespace: "{{ $pathIndexNamespace }}"
                  isNamespaced: true
                  dataForControls:
