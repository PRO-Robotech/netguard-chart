{{- define "netguard.web-resources.factory.manifets.svcsvcrule-details" -}}
{{- $key          := (default "svcsvcrule-details" .key) -}}
                                  ...
                                  - type: Labels
                                    data:
                                      containerStyle:
                                        marginTop: -30px
                                      editModalWidth: 650
                                      endpoint: "/api/clusters/{{ $pathIndexCluster }}/k8s/apis/netguard.sgroups.io/v1beta1/namespaces/{{ $pathIndexNamespace }}/svcsvcrules/{{ $pathIndexResName }}"
                                      id: labels-editor
                                      inputLabel: ""
                                  ...
                                  - type: antdFlex
                                    ...
                                    children:
                                      ...
                                      - type: antdLink
                                        data:
                                          id: ns-link
                                          href: "/{{ $pathIndexBasePrefix }}/{{ $pathIndexCluster }}/{reqsJsonPath[0]['.items.0.spec.serviceFrom.namespace']['-']}/factory/hbf-service-details/netguard.sgroups.io/v1beta1/services/{reqsJsonPath[0]['.items.0.spec.serviceFrom.name']['-']}"
                                        {{ if eq ($nsAliasMode | toString) "true" }}
                                          text: |
                                            {reqsJsonPath[1]['.items[?(@.metadata.name=="{reqsJsonPath[0][".items.0.spec.serviceFrom.namespace"]}")].metadata.labels.alias']["-"]}/{reqsJsonPath[0][".items.0.spec.serviceFrom.name"]["-"]}
                                        {{ else }}
                                          text: '{reqsJsonPath[0][".items.0.spec.serviceFrom.namespace"]["-"]}/{reqsJsonPath[0][".items.0.spec.serviceFrom.name"]["-"]}'
                                        {{ end }}
                                  ...
                                  - type: antdFlex
                                    ...
                                    children:
                                      ...
                                      - type: antdLink
                                        data:
                                          id: ns-link
                                          href: "/{{ $pathIndexBasePrefix }}/{{ $pathIndexCluster }}/{reqsJsonPath[0]['.items.0.spec.serviceTo.namespace']['-']}/factory/hbf-service-details/netguard.sgroups.io/v1beta1/services/{reqsJsonPath[0]['.items.0.spec.serviceTo.name']['-']}"
                                        {{ if eq ($nsAliasMode | toString) "true" }}
                                          text: |
                                            {reqsJsonPath[1]['.items[?(@.metadata.name=="{reqsJsonPath[0][".items.0.spec.serviceTo.namespace"]}")].metadata.labels.alias']["-"]}/{reqsJsonPath[0][".items.0.spec.serviceTo.name"]["-"]}
                                        {{ else }}
                                          text: '{reqsJsonPath[0][".items.0.spec.serviceTo.namespace"]["-"]}/{reqsJsonPath[0][".items.0.spec.serviceTo.name"]["-"]}'
                                        {{ end }}
                                ...
                                children:
                                  ...
                                  - type: TogglerSegmented
                                    data:
                                      ...
                                      reqIndex: 0
                                      jsonPathToValue: ".items.0.spec.action"
                                      notificationSuccessMessage: Updated successfully
                                      ...
                                      endpoint: /api/clusters/{{ $pathIndexCluster }}/k8s/apis/{reqsJsonPath[0]['.items.0.apiVersion']['-']}/namespaces/{reqsJsonPath[0]['.items.0.metadata.namespace']['-']}/svcsvcrules/{reqsJsonPath[0]['.items.0.metadata.name']['-']}
