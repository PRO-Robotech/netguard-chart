{{- define "netguard.web-resources.factory.manifets.svcfqdnrule-details" -}}
{{- $key          := (default "svcfqdnrule-details" .key) -}}
                                  ...
                                  - type: Labels
                                    data:
                                      containerStyle:
                                        marginTop: -30px
                                      editModalWidth: 650
                                      endpoint: "/api/clusters/{{ $pathIndexCluster }}/k8s/apis/netguard.sgroups.io/v1beta1/namespaces/{{ $pathIndexNamespace }}/svcfqdnrules/{{ $pathIndexResName }}"
                                      id: labels-editor
                                      inputLabel: ""
                              ...
                              - type: antdFlex
                                ...
                                children:
                                  ...
                                  - type: parsedText
                                    data:
                                      id: cidr-value
                                      text: '{reqsJsonPath[0][".items.0.spec.fqdn"]["-"]}  {reqsJsonPath[0][".items.0.spec.transport"]["-"]}/{reqsJsonPath[0][".items.0.spec.ports[*].port"]["-"]}'
                                      # TODO: Выводится только первый порт из списка
                                ...
                                children:
                                  ...
                                  - type: TogglerSegmented
                                    data:
                                      ...
                                      endpoint: /api/clusters/{{ $pathIndexCluster }}/k8s/apis/{reqsJsonPath[0]['.items.0.apiVersion']['-']}/namespaces/{reqsJsonPath[0]['.items.0.metadata.namespace']['-']}/svcfqdnrules/{reqsJsonPath[0]['.items.0.metadata.name']['-']}
