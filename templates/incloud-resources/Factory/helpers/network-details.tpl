{{- define "netguard.web-resources.factory.manifets.network-details" -}}
{{- $key          := (default "network-details" .key) -}}
                                  ...
                                  - type: Labels
                                    data:
                                      containerStyle:
                                        marginTop: -30px
                                      editModalWidth: 650
                                      endpoint: "/api/clusters/{{ $pathIndexCluster }}/k8s/apis/netguard.sgroups.io/v1beta1/namespaces/{{ $pathIndexNamespace }}/networks/{{ $pathIndexResName }}"
                                      id: labels-editor
                                      inputLabel: ""
                              ...
                              - type: antdFlex
                                ...
                                children:
                                  ...
                                  - type: parsedText
                                    data:
                                      id: cidr-value
                                      text: '{reqsJsonPath[0][".items.0.spec.cidr"]["-"]}'
